          ...
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
            ...
            >
              <Image
                ...
                width={570}
                height={500}
                className="pr-0 lg:pr-16 w-full object-cover rounded-md"
              />
            </ScrollReveal>
          </div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <ScrollReveal initialY={30} delay={0.2}>
              <div className="mb-[30px] bg-white p-[25px] lg:p-[30px] rounded-[10px] border border-[#eee] transition-all duration-300 hover:border-l-4 hover:border-l-[#2a9d8f] shadow-sm hover:shadow-md">
                ...
                <h4 className="font-extrabold overflow-hidden mb-2.5 text-[20px] lg:text-[22px] text-[#264653]">{t('f1Title')}</h4>
            ...
            <ScrollReveal initialY={30} delay={0.3}>
              <div className="mb-[30px] bg-white p-[25px] lg:p-[30px] rounded-[10px] border border-[#eee] transition-all duration-300 hover:border-l-4 hover:border-l-[#2a9d8f] shadow-sm hover:shadow-md">
                ...
                <h4 className="font-extrabold overflow-hidden mb-2.5 text-[20px] lg:text-[22px] text-[#264653]">{t('f2Title')}</h4>
