      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center -mx-[15px]">				
          <div className="w-full lg:w-1/2 px-[15px]">
            <div className="login bg-white p-[50px] shadow-[0_0_20px_rgba(0,0,0,0.05)] rounded-[6px]">
              <h4 className="login_register_title text-[24px] font-bold text-penn-navy mb-[30px]">Already a member? Sign in:</h4>
              <form>
                ...
                <div className="form-group w-full mb-[20px]">
                  <button className="bg-penn-green text-white text-[16px] font-bold uppercase px-[40px] h-[50px] rounded-[30px] transition-colors hover:bg-penn-navy w-full" type="submit" name="submit">login</button>
                </div>
                <p className="text-penn-body text-[15px] m-0 text-center">Don't have an account? <Link href="/register" className="text-penn-green font-bold hover:underline">Register Now</Link></p>
              </form>
            </div>
          </div>	
        </div>
