        ...
        <div className="grid grid-cols-1 md:grid-cols-3">
          {promos.map((promo, i) => (
            ...
            >
              ...
              <a 
                href={promo.link} 
                className={`inline-block px-8 py-3 rounded-full text-white uppercase text-[13px] tracking-wide font-bold transition-opacity hover:opacity-90 ${promo.bgColor}`}
              >
                {promo.ctaText}
              </a>
            </motion.div>
