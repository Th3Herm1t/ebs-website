          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-5">
              ...
              <li className="flex gap-4 items-center group mt-2">
                ...
                <a href="https://wa.me/21629582835" target="_blank" rel="noopener noreferrer" className="text-white/80 text-[15px] hover:text-[#25D366] transition-colors font-medium">
                  WhatsApp
                </a>
              </li>
            </ul>
