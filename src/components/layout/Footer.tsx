            ...
            <ul className="space-y-5">
              ...
              <li className="flex gap-4 items-center group">
                ...
                <div className="flex flex-col text-white/80 text-[15px]">
                  <a href="tel:+21653355196" className="hover:text-penn-green transition-colors">+216 53 355 196</a>
              ...
              <li className="flex gap-4 items-center group mt-2">
                ...
                <a href="https://wa.me/21653355196" target="_blank" rel="noopener noreferrer" className="text-white/80 text-[15px] hover:text-[#25D366] transition-colors font-medium">
                  WhatsApp
                </a>
              </li>
            </ul>
