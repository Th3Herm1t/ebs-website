...
export default function CoursesSection() {
  ...
  const licences = [
    { img: "/images/programs/management.jpg", cat: t('licences.0.cat'), title: t('licences.0.title'), detail1: t('licences.0.detail1'), detail2: t('licences.0.detail2'), slug: "management", type: "licence" as const },
    { img: "/images/programs/marketing.png", cat: t('licences.1.cat'), title: t('licences.1.title'), detail1: t('licences.1.detail1'), detail2: t('licences.1.detail2'), slug: "marketing", type: "licence" as const },
    { img: "/images/programs/finance.png", cat: t('licences.2.cat'), title: t('licences.2.title'), detail1: t('licences.2.detail1'), detail2: t('licences.2.detail2'), slug: "finance", type: "licence" as const },
    { img: "/images/programs/informatique-ia.png", cat: t('licences.3.cat'), title: t('licences.3.title'), detail1: t('licences.3.detail1'), detail2: t('licences.3.detail2'), slug: "informatique-ia", type: "licence" as const },
    { img: "/images/programs/cybersecurite.jpg", cat: t('licences.4.cat'), title: t('licences.4.title'), detail1: t('licences.4.detail1'), detail2: t('licences.4.detail2'), slug: "cybersecurite", type: "licence" as const },
  ];
