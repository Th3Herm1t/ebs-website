...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return pageMetadata({
    ...
    description: "Espima Business School propose des Licences, Masters, parcours internationaux et un catalogue v3 de ressources et credentials gratuits vérifiés en management, finance, marketing, informatique, IA et cybersécurité.",
    path: `/${locale}`,
  });
}
