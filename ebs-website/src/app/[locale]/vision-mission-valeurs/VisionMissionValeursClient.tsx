...
const valeurs = [
  ...
  },
  {
    ...
    concret: "IA intégrée dans tous les programmes · 199 certifications et badges vérifiés · Pédagogie innovante",
    color: "#9C27B0",
  },
  {
    number: "03",
    ...
    <>
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <Image src="/images/heroes/hero-vision.jpg" alt="" fill className="object-cover" priority sizes="100vw" />
        </div>
        {/* Overlay */}
