        ...
        <div className="max-w-[1160px] mx-auto px-5 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { icon: <Award className="w-7 h-7" />, title: "Certifications Mondiales", text: `Des certifications et badges proposés par Google, IBM, Harvard, Cisco, Bloomberg, Microsoft, Fortinet, HubSpot, DeepLearning.AI et plus de 30 autres organismes internationaux. ${publicCertificationCountLabel} certifications et justificatifs sont gratuits et intégrés dans nos parcours.`, color: "#FF9800" },
            ].map((acc, i) => (
