      ...
      <section className="relative pt-40 pb-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1280px] mx-auto px-5 lg:px-12">
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.5 }} className="flex flex-wrap justify-center gap-4 md:gap-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-5 text-center w-[calc(50%-8px)] md:w-[calc((100%-96px)/5)]"><p className="text-[32px] md:text-[44px] font-extrabold text-penn-green leading-none mb-1">199</p><p className="text-[13px] text-white/50 font-medium">Certifications incluses</p></div>
        ...
        <div className="max-w-[1280px] mx-auto px-5 lg:px-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            {[
              ...
              { end: 199, label: "Certifications incluses", sublabel: "Google · IBM · Harvard · Bloomberg · Cisco...", icon: <Award className="w-7 h-7" />, featured: true },
        ...
        <div className="max-w-[1160px] mx-auto px-5 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { icon: <Award className="w-7 h-7" />, title: "Certifications Mondiales", text: "Des certifications et badges proposés par Google, IBM, Harvard, Cisco, Bloomberg, Microsoft, Fortinet, HubSpot, DeepLearning.AI et plus de 30 autres organismes internationaux. 199 certifications et justificatifs sont gratuits et intégrés dans nos parcours.", color: "#FF9800" },
            ].map((acc, i) => (
