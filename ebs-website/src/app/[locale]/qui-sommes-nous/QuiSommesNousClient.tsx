...
const timeline = [
  ...
  { year: "2026", title: "Le virage de l'IA", text: "EBS devient la première université tunisienne à intégrer l'intelligence artificielle comme compétence transversale obligatoire dans tous ses cursus. 131 certifications internationales sont affichées, en partenariat avec Google, IBM, Harvard, Bloomberg et plus de 15 partenaires technologiques internationaux.", highlight: true, image: "/images/sections/pillar-tech.jpg" },
];
        ...
        <div className="max-w-[1160px] mx-auto px-5 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              { icon: <Award className="w-7 h-7" />, title: "Certifications Mondiales", text: "Des certifications proposées par Google, IBM, Harvard, Cisco, Bloomberg, Fortinet, HubSpot, DeepLearning.AI et plus de 15 autres organismes internationaux. 131 certifications internationales sont affichées dans nos parcours.", color: "#FF9800" },
            ].map((acc, i) => (
